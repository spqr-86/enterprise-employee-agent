...
|---|---|---|---|---|
| P0 | Reconcile and bootstrap | Makes the documented workflow executable | Current spec/framework | local implementation on `chore/bootstrap`; Issue blocked by GitHub 401 |
